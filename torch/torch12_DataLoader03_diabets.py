...
test_loader = DataLoader(test_set, batch_size=120, shuffle=True)
...
#2. 모델
# model = nn.Sequential(
#     nn.Linear(64, 64),   # 앞에는 컬럼 갯수
#     nn.ReLU(),
#     nn.Linear(64, 32),
#     nn.ReLU(),
#     nn.Linear(32, 16),
#     nn.ReLU(),
#     nn.Linear(16, 10),   # 마지막은 y의 유니크값 갯수 3개  # 클래스 갯 수에 맞춰서 해야한다.
...
criterion = nn.CrossEntropyLoss()    # CrossEntropyLoss : spars_crossEntropy  
...
# =========== 평가, 예측 =============
# loss :  1.5032809972763062
# tensor([3, 3, 4, 1, 1, 3, 1, 0, 7, 4], device='cuda:0')
# accuracy : 0.9593
# accuracy_score :  0.959259259259259