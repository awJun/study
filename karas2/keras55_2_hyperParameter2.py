"""
[해당 프로젝트 설명]
https://colab.research.google.com/drive/17ci4wEaCa4itriEysLF11xf8SsXs_zIN
...
# 2.모델 
def build_model(drop=0.5, optimizer = Adam, activation='relu', node=128, node2=64, node3=32, lr=1):
