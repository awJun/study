...
# # # target이 r2 또는 acc이다
# # {'target': 0.8356243329041582, 'params': {'colsample_bytree': 0.5, 'max_bin': 34.00541124251053, 
# # 'max_depth': 6.0, 'min_child_samples': 10.0, 'min_child_weight': 1.0, 'num_leaves': 24.0, 'reg_alpha': 0.01, 
...
# # # 결과
# # {'target': 0.843330422757568, 'params': {'colsample_bytree': 0.9558253483836334, 'max_bin': 34.31545945797744,
# # 'max_depth': 4.714584825749489, 'min_child_samples': 9.088029811600514, 'min_child_weight': 1.6570261887374473,
# # 'num_leaves': 25.93480212337689, 'reg_alpha': 0.009572667475313748, 'reg_lambda': 11.967356238382687,
# # 'subsample': 0.6941304916460904}}
