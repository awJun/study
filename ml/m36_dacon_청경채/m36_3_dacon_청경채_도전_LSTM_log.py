...
# [로그 재도전 ? 임시 보류]
####[ 로그 변환 작업 ]###########################################################################
x_train['내부온도관측치'] = np.log1p(x_train['내부온도관측치']) 
x_train['내부습도관측치'] = np.log1p(x_train['내부습도관측치'])     
x_train['CO2관측치'] = np.log1p(x_train['CO2관측치'])     
x_train['외부온도관측치'] = np.log1p(x_train['외부온도관측치'])     
x_train['외부습도관측치'] = np.log1p(x_train['외부습도관측치'])     
x_train['냉방부하'] = np.log1p(x_train['냉방부하'])   
    
x_test['내부온도관측치'] = np.log1p(x_test['내부온도관측치'])      
x_test['내부습도관측치'] = np.log1p(x_test['내부습도관측치'])     
x_test['CO2관측치'] = np.log1p(x_test['CO2관측치'])     
x_test['외부온도관측치'] = np.log1p(x_test['외부온도관측치'])     
x_test['외부습도관측치'] = np.log1p(x_test['외부습도관측치'])     
x_test['냉방부하'] = np.log1p(x_test['냉방부하'])      
