...
parameters = [
    {'randomforestclassifier__n_estimators':[100, 200],'max_depth':[6, 8],'randomforestclassifier__min_samples_leaf':[3,5],
     'randomforestclassifier__min_samples_split':[2, 3],'n_jobs':[-1, 2]},
    {'randomforestclassifier__n_estimators':[300, 400],'max_depth':[6, 8],'randomforestclassifier__min_samples_leaf':[7, 10],
     'randomforestclassifier__min_samples_split':[4, 7],'n_jobs':[-1, 4]} 
    ]                                                                      
