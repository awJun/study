...
cat = CatBoostClassifier(random_state=123439, verbose=False, n_estimators=1000)
...
# cat = CatBoostClassifier(random_state=123, verbose=False, n_estimators=1000)
# 최상의 점수 :  0.9045300878972279
# acc : 0.9534883720930233
# 걸린 시간 : 4.554198980331421


# cat = CatBoostClassifier(random_state=12345, verbose=False, n_estimators=1000)
# 최상의 점수 :  0.9085610309032335
# acc : 0.9593023255813954
# 걸린 시간 : 6.510353088378906


# cat = CatBoostClassifier(random_state=123451, verbose=False, n_estimators=1000)
# 최상의 점수 :  0.905685479059778
# acc : 0.9651162790697675
# 걸린 시간 : 6.398538112640381


# cat = CatBoostClassifier(random_state=123439, verbose=False, n_estimators=1000)
# 최상의 점수 :  0.9085570536531042
# acc : 0.9651162790697675
# 걸린 시간 : 6.463866472244263
...
#                                                  random_state=1234,
#                                                  stratify=y)
# cat = CatBoostClassifier(random_state=123436, verbose=False, n_estimators=1000)
# 최상의 점수 :  0.8925201879915147
# acc : 0.9184100418410042
# 걸린 시간 : 6.306725978851318
