...
#4. 평가, 예측
y1_loss = model.evaluate([x1_test, x2_test, x3_test], y1_test)  # https://ebbnflow.tistory.com/133
y2_loss = model.evaluate([x1_test, x2_test, x3_test], y2_test)  # https://ebbnflow.tistory.com/133
...
# y1_loss :  1800.0592041015625
# y1의 r2스코어 :  -4290.540375852949

# y2_loss :  0.2329559326171875
# y2의 r2스코어 :  0.999891405536875

# 걸린시간 :  5.788857698440552

# y1_loss :  [1802.8125, 4.164282321929932, 1798.648193359375]    # 1802.8125는 뒤에 두 로스 총합 로스 /  4.164282321929932는 y1_train의 로스 / 1798.648193359375는 y2_train의 로스
# y2_loss :  [1806.8687744140625, 1804.164306640625, 2.7044804096221924]        # ^-- 위와 방식 동일
# y1의 r2스코어 :  0.9759951327241555
# y2의 r2스코어 :  0.9878977977371293
# 걸린시간 :  7.035829067230225
...
#==[ 이건 안돌아감 ] === (값 오류: 풀 수 있는 값이 너무 많습니다(예측값 2).라고 뜸) 고로 사용 불가.
# #2-3 모델 concate(엮기)
# from tensorflow.python.keras.layers import concatenate, Concatenate  # <- 그냥 같이 붙여버리는 개념
...
#2-3 모델 concatenate (concate : 엮기)
# # concate : 엮다         <--리스트에서 .append 개념이라 생각하면 된다.

# # y1의 last_output1---------------------------------------------------------------
# merge2 = Dense(200, activation='relu', name='mg2_1')(merge1)
# merge3 = Dense(30, name='mg3_1')(merge2)
# last_output1 = Dense(1, name='last1')(merge3)   # <-- 레이어이므로 마지막은 1
# #---------------------------------------------------------------------------------
# # y2의 last_output2---------------------------------------------------------------
# merge2_2 = Dense(200, activation='relu', name='mg2_2')(merge1)
# merge3_2 = Dense(30, name='mg3_2')(merge2_2)
# last_output2 = Dense(1, name='last2')(merge3_2)
# #---------------------------------------------------------------------------------
