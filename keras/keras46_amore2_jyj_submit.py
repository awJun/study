...
# 정규화 대상 column 정의
scale_cols = ['고가', '저가', '종가', '거래량', '개인', '기관', '외국계', '연도', '월', '일']
...
# (입력_데이터)
feature_cols = ['고가', '저가', '종가', '거래량', '개인', '기관', '외국계', '연도', '월', '일']
label_아모레 = 아모레_데이터['시가']
# label_cols = ['종가'] # 내일 사용
...
# hist = model.fit([아모레_x_train, 삼성_x_train], [아모레_y_train, 삼성_y_train], epochs=10000, batch_size=100,
...
# 아모레, 삼성의 로스값 :   [218970030080.0, 158876745728.0, 60093288448.0]
# [132058.42]
# 아모레의 r2스코어 :  -1.2731894210227197
# 삼성의 r2스코어 :  -1.9003899345122148
