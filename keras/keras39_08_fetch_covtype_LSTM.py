...
# print(y_train.shape)   # (464809,)
# print(x_test.shape)    # (116203, 54)
# print(y_test.shape)    # (116203,)
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -   
...
# print(x_train.shape)  # (464809, 54, 1, 1) 
# print(x_test.shape)   # (116203, 54, 1, 1)
#- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
#2. 모델구성
model = Sequential()
model.add(LSTM(units=100 ,input_length=54, input_dim=1))   #SimpleRNN  또는 LSTM를 거치면 3차원이 2차원으로 변형되어서 다음 레어어에 간다.
...
# loss :  0.7671301960945129
# accuracy :  0.6394413225131881
# 걸린시간 :  160.14452815055847