...
x_train = np.load('D:/study_data/_save/_npy/horse_or_human/keras49_7_x_train_data.npy')
y_train = np.load('D:/study_data/_save/_npy/horse_or_human/keras49_7_y_train_data.npy')
x_test = np.load('D:/study_data/_save/_npy/horse_or_human/keras49_7_x_test_data.npy')
y_test = np.load('D:/study_data/_save/_npy/horse_or_human/keras49_7_y_test_data.npy')
...
# loss : 6.604110967600718e-05
# val_loss : 0.967867910861969
# accuracy : 1.0
