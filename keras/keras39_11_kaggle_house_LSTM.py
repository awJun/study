...
# print(y_train.shape)   # (1003,)
# print(x_test.shape)    # (335, 12)
# print(y_test.shape)    # (335,)
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
#- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#--[차원 변형 작업]- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
x_train = x_train.reshape(1003, 6, 2)               
x_test = x_test.reshape(335, 6, 2)

# print(x_train.shape)  # (1003, 6, 2, 1)     <-- "6, 2 ,1"는 input_shape값
# print(x_test.shape)   # (335, 6, 2, 1)
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
#2. 모델구성
model = Sequential()
model.add(LSTM(units=100 ,input_length=6, input_dim=2))   #SimpleRNN  또는 LSTM를 거치면 3차원이 2차원으로 변형되어서 다음 레어어에 간다.
...
# loss :  39434506240.0
# acc :  0.0
# RMSE :  198578.09731410348
# r2스코어 :  -5.872029907959697
# 걸린시간: 79.07718276977539
