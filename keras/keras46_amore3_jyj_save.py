...
hist = model.fit([아모레_x_train, 삼성_x_train], [아모레_y_train, 삼성_y_train], epochs=230, batch_size=50,
...
# 나의 목표 종가 : 133500 !!
# 아모레, 삼성의 로스값 :   [446725423104.0, 152746147840.0, 293979291648.0]
# 아모레 종가 가격 :  [131029.29]
