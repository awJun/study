...
#2. 모델구성
model = Sequential()
model.add(LSTM(units=100 ,input_length=4, input_dim=2))   #SimpleRNN  또는 LSTM를 거치면 3차원이 2차원으로 변형되어서 다음 레어어에 간다.
...
# loss :  68026.671875
# acc :  0.013778322376310825
# RMSE :  258.35168310205694
# r2스코어 :  -1.0654265870852235
# 걸린시간: 6.264621019363403
