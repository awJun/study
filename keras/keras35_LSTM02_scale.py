...
model.add(LSTM(units=100 ,input_length=3, input_dim=1))   #SimpleRNN  또는 LSTM를 거치면 3차원이 2차원으로 변형되어서 다음 레어어에 간다.
...
model.fit(x_train, y_train, epochs=1000, batch_size=32, verbose=1,   # batch_size의 디폴트값 = 32 즉 32이는 넣으나 마나임 ~
...
# loss :  3.3844234943389893
# [50, 60, 70의 결과 :  [[82.324]]

# loss :  2.8852005004882812
# [50, 60, 70의 결과 :  [[79.18533]]

# loss :  3.449798583984375
# [50, 60, 70의 결과 :  [[81.402336]]