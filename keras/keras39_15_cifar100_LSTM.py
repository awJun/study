...
# print(np.unique(y_train, return_counts=True))    # <--- 이 항목은 확인 필수   회귀모델이다.
...
# 2. 모델구성
model = Sequential()
model.add(LSTM(units=100 ,input_length=96, input_dim=32))   #SimpleRNN  또는 LSTM를 거치면 3차원이 2차원으로 변형되어서 다음 레어어에 간다.
...
# loss :  5.900860287511023e-06
# acc :  0.009999999776482582
# accuracy :  1.0
# 걸린시간 :  304.65942096710205
...
# max
# accuracy: 0.1298
# loss :  3.7340731620788574
# accuracy :  0.1298000067472458
